...
const Home: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if ($('#fullpage').length > 0) {
            new fullpage('#fullpage', {
                ...
                anchors: [
                    'welcome', 'how-it-works', 'earning-credit', 'download-app', 'faqs',
                    'follow-us', 'success-stories', 'services', 'technology-expertise',
                    'engagement-models', 'happy_clients', 'journey',
                    'corporate-social-responsibilities', 'group-of-companies',
                    'cheerful-workforce', 'global-presence'
                ],
                navigation: true,
    ...
    useEffect(() => {
        const setupMarquee = (selector: string, speed: number, direction: "left" | "right" = "left"): void => {
            ...
            const startScrolling = () => {
                if (!isHovered) {
                    ...
                    if (
                        direction === "left" &&
                        Math.abs(scrollAmount) >= contentWidth
                    ) {
                        scrollAmount = 0;
    ...
    return (
        <>
            ...
            <div id="fullpage">
                ...
                <div className="main-hero-sec fix vertical-scrolling" data-anchor="welcome">
                    <section className="hero-section hero-4">
                            ...
                            <div className="row g-0">
                                <div className="col-lg-9">
                                    <div className="hero-content">
                                        ...
                                        <h1 className="wow fadeInUp" data-wow-delay=".3s">Swap your place, explore the world.</h1>
                                        <div className="d-flex justify-content-between align-items-center discover-btn">
                                            <p className="wow fadeInUp" data-wow-delay=".5s">
                                                Join a global community of explorers, swapping<br /> homes and saving on travel.
                                            </p>
                                            <a href="#!" className="theme-btn padding-style wow fadeInUp bg-black "
                                                data-wow-delay=".7s">
                                                Discover our places
                        ...
                        <div className="row hide-on-desktop">
                            <a href="#!" className="theme-btn padding-style wow fadeInUp bg-black bottom-new" data-wow-delay=".7s">
                                Discover our places
                ...
                <section className="about-section fix section-padding vertical-scrolling" data-anchor="about">
                    <div className="container">
                                ...
                                <div className="col-lg-12 mt-5 mt-lg-0">
                                    <div className="about-content text-center">
                                        ...
                                        <p className="mt-3 about-p mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                            Swap your home, earn credits, and explore the world like never before!
                                        </p>
                                                ...
                                                <div className="feature-card card1">
                                                    <div className="feature-content">
                                                        ...
                                                        <div className="feature-image">
                                                            <img src={addPlace} className="w-100"
                                                                alt="Feature Image" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="feature-card">
                                                    <div className="feature-content">
                                                        <div className="feature-details">
                                                            ...
                                                            <h3 className="feature-title">Earn Credits by hosting</h3>
                                                            <p className="feature-description">
                                                                Earn credits every time someone<br /> stays at your place
                                                            </p>

                                                        </div>

                                                        <div className="feature-image">
                                                            <img src={earnCredit} className="w-100"
                                                                alt="Feature Image" />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="">
                                                <div className="feature-card d-block image-need">
                                                    ...
                                                    <div className="feature-image-img">
                                                        <img src={useCredit} className="" alt="Feature Image" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
  ...
  `}</style>
                                                ...
                                                <Swiper
                                                    ...
                                                    spaceBetween={10}
                                                    slidesPerView={1.10} // Show 1 full + 10% of next
                                                    loop={true}
                                                    autoplay={{
                                                        delay: 3000,
                                        ...
                                        <div className="about-button wow fadeInUp" data-wow-delay=".9s">
                                            <a href="#!" className="theme-btn padding-style register-btn">Register your place</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="service-section-2 fix section-padding vertical-scrolling" data-anchor="service"
                    style={{
                    ...
                    <div className="container">
                        <div className="row align-items-center justify-content-center">
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp define-width" data-wow-delay=".3s">
                                <div className="service-box-items style-2">

                                    <div className="content">
                                        <h4 className="splt-txt wow" data-splitting>
                                            <a href="#!">Earning credits by
                                                Hosting</a>
                                        </h4>
                                        <p>
                                            For every night a guest stays at <br />
                                            your place, receive <span className="credt-bold"> 1 credit!</span>
                                        </p>
                            ...
                            <div className="d-flex justify-content-center gap-3 align-items-center nocost mobile">
                                <a href="" className="no-member"><img src={memeberShip} /> No membership fees</a>
                                <a href="" className="no-member hiden-cost"><img src={noHidenCost} width="29px" />
                                    No hidden costs</a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="section-padding app-section vertical-scrolling" data-anchor="app">
                    <div className="cta-video-wrapper bg-cover application"
                        style={{ backgroundImage: `url(${appSec})`, backgroundSize: "cover" }}>
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-5">
                                    ...
                                    <div className="btn-white mob-new">
                                        ...
                                        <a href="#!" className="d-flex align-items-center white opacity-low">
                ...
                <section className="faq-section section-padding fix vertical-scrolling" data-anchor="faq">
                    <div className="container">
                                        ...
                                        <div className="accordion" id="accordion">
                                            <div className="accordion-item mb-4 wow fadeInUp" data-wow-delay=".3s">
                                                ...
                                                <div id="faq1" className="accordion-collapse collapse" data-bs-parent="#accordion">
                                                    <div className="accordion-body">
                                                        KazaSwap is a home exchange platform that allows members to swap homes
                                                        with others using credits, offering a flexible and cost-effective way to
                                                        travel.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item mb-4 wow fadeInUp" data-wow-delay=".5s">
                                                ...
                                                <div id="faq2" className="accordion-collapse collapse" data-bs-parent="#accordion">
                                                    <div className="accordion-body">
                                                        Credits can be earned by hosting people at your place with our app, or
                                            ...
                                            <div className="accordion-item mb-4 wow fadeInUp" data-wow-delay=".7s">
                                                ...
                                                <div id="faq3" className="accordion-collapse collapse" data-bs-parent="#accordion">
                                                    <div className="accordion-body">
                                                        Upon registration, members receive 5 credits, equivalent to 5 nights
                                                        stay in another city.To earn more credits, members can host other
                                                        traveler's in their homes or participate in the reward program. There
                                                        are no mandatory memberships, and credits do not expire.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item wow  mb-4  fadeInUp" data-wow-delay=".7s">
                                                ...
                                                <div id="faq4" className="accordion-collapse collapse" data-bs-parent="#accordion">
                                                    <div className="accordion-body">
                                                        Create an account and provide detailed information about your property,
                                                        including photos, amenities, and availability. Once your home is listed,
                                                        it becomes part of the Kaza Swap community for others to request a stay.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item wow fadeInUp" data-wow-delay=".7s">
                                                ...
                                                <div id="faq5" className="accordion-collapse collapse" data-bs-parent="#accordion">
                                                    <div className="accordion-body">
                                                        Browse available properties and send a request to the host. Once the
                                                        host accepts, the swap is confirmed, and the service fee is applied.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="last-section vertical-scrolling" data-anchor="insta">
                    <div className="section-padding pb-0 insta-section">
                        <div className="cta-video-wrapper bg-cover1 insta-img"
                            style={{ backgroundImage: `url(${instaBg})`, backgroundSize: "cover" }}>
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-5">

                                        <h2>Follow us on <br />
                                            <img src={instagramImg} width="50px" /> Instagram,<br />
                                            and share your <br />journey!
                                        </h2>

                                        <div className="btn-white justify-content-start">
                                            <a href="https://www.instagram.com/kazaswap.app/" className="white yellow">
                                                <p>Follow Us</p>
                                            </a>
                                                        ...
                                                        <div className="gallery-h">
                                                            <div className="gallery-image relative">
                                                                <div className="gallery-image__img relative">
                                                                    <div className="fill-dimensions cover-img" style={{ backgroundImage: `url(${instaPic})` }}></div>
                                                                </div>
                                                            </div>
                                                            <div className="gallery-image">
                                                                <div className="gallery-image__img relative">
                                                                    <div className="fill-dimensions cover-img" style={{ backgroundImage: `url(${instaPic1})` }}></div>
                                                                </div>
                                                            </div>
                                                            <div className="gallery-image">
                                                                <div className="gallery-image__img relative">
                                                                    <div className="fill-dimensions cover-img" style={{ backgroundImage: `url(${instaPic2})` }}></div>
                                                                </div>
                                                            </div>

                                                        </div>
                                                    </div>
                                                </div><div className="block-33 display--inline-top">
                                                    <div className="gutter relative">
                                                        <div className="gallery-h gallery-h--tb">
                                                            <div className="gallery-image relative">
                                                                <div className="gallery-image__img relative">
                                                                    <div className="fill-dimensions cover-img" style={{ backgroundImage: `url(${instaPic3})` }}></div>
                                                                </div>
                                                            </div>
                                                            <div className="gallery-image">
                                                                <div className="gallery-image__img relative">
                                                                    <div className="fill-dimensions cover-img" style={{ backgroundImage: `url(${instaPic4})` }}></div>
                                                                </div>
                                                            </div>
                                                            <div className="gallery-image">
                                                                <div className="gallery-image__img relative">
                                                                    <div className="fill-dimensions cover-img" style={{ backgroundImage: `url(${instaPic5})` }}></div>
                                                                </div>
                                                            </div>
            ...
            <div fs-cc="banner" className="cookie-popup">
                <div className="cookie-popup__block">
                    <div className="cookie-popup__icon"><img src={cookie} loading="lazy" alt="cookie
        "/></div>
                    <div className="cookie-popup__text">We use cookies to provide you with a personalised experience. To find out
                        more and learn how to opt out, read our cookie policy.</div>
                    <div className="cookie-popup__buttons">
                        <a fs-cc="deny" href="#!" className="cookie-popup__link grey w-button" role="button" tabIndex={0}>Reject</a>
                        <a fs-cc="allow" href="#!" className="cookie-popup__link w-button" role="button" tabIndex={0}>Agree &amp;
                            Proceed</a>
                    </div>
                </div>
            </div>
