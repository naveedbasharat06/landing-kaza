...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        //>> Scroll Js Start <<
            ...
            if (!scrollPath) {
                console.warn("Element '.scroll-up path' not found.");
                return;
            }
            ...
            scrollPath.getBoundingClientRect(); // Force reflow
            scrollPath.style.transition = scrollPath.style.WebkitTransition = "stroke-dashoffset 10ms linear";

            updateScroll = function () {
                let scrollTotal = window.scrollY || window.pageYOffset;
                let height = document.documentElement.scrollHeight - window.innerHeight;
                let scrollOffset = pathLength - (scrollTotal * pathLength) / height;
